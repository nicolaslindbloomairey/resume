...
\textbf{Pokemon Battle Simulator} \hfill \href{https://github.com/nicolaslindbloomairey/pokemon-python}{\faicon{github} \textit{pokemon-python}}
\begin{itemize}
    \item 40x faster than leading battle simulator with AI vs AI battles
\end{itemize}

\textbf{Taylor Swift Translator} \hfill \href{https://github.com/nicolaslindbloomairey/taylorswifttranslator}{\faicon{github} \textit{taylorswifttranslator}}
\begin{itemize}
